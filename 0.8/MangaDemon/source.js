...
var _Sources = (() => {
  ...
  var MD_IMAGE_CDN = "https://cdn.demoniclibs.com";
  var MangaDemonInfo = {
    version: "1.2.0",
    name: "MangaDemon",
    icon: "icon.png",
  ...
  var MangaDemon = class _MangaDemon {
    ...
    async getSearchTags() {
      ...
      return [
        ...
        ...namespaceTagSections(
          ...
          "genre",
          "multiple",
          /* @__PURE__ */ new Set(["adult", "hentai", "smut", "yaoi"])
        )
      ];
    }
    async getSearchResults(query, metadata) {
      ...
      if (query.title) {
        ...
        const genres = includedValues(query, "genre").map((value) => `&genre[]=${encodeURIComponent(value)}`).join("");
