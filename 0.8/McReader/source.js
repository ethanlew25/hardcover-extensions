...
var _Sources = (() => {
  ...
  var require_named_references = __commonJS({
    "node_modules/.pnpm/html-entities@2.5.2/node_modules/html-entities/lib/named-references.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  var require_numeric_unicode_map = __commonJS({
    "node_modules/.pnpm/html-entities@2.5.2/node_modules/html-entities/lib/numeric-unicode-map.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  var require_surrogate_pairs = __commonJS({
    "node_modules/.pnpm/html-entities@2.5.2/node_modules/html-entities/lib/surrogate-pairs.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  var require_lib2 = __commonJS({
    "node_modules/.pnpm/html-entities@2.5.2/node_modules/html-entities/lib/index.js"(exports) {
      "use strict";
      ...
      function decodeEntity(entity, _a3) {
        var _b = (_a3 === void 0 ? defaultDecodeEntityOptions : _a3).level, level = _b === void 0 ? "all" : _b;
        if (!entity) {
          return "";
        }
  ...
  var parseTags = ($2) => {
    const arrayTags = [];
    const modernTags = $2('[data-group="include_genres"][data-value]').toArray();
    if (modernTags.length > 0) {
      for (const tag of modernTags) {
        const title = $2(tag).attr("data-value")?.trim() ?? "";
        const label = $2(tag).text().trim();
  ...
  var parseBrowseResponse = (data2) => {
    const response = typeof data2 === "string" ? JSON.parse(data2) : data2;
    const $2 = load(response.results_html ?? "");
    const results = [];
    const seen = /* @__PURE__ */ new Set();
    for (const card of $2("article.comic-card").toArray()) {
      const link = $2('a[href*="/manga/"]', card).first();
      const mangaId = link.attr("href")?.match(/\/manga\/([^/?#]+)/i)?.[1] ?? "";
      const title = $2("h3.comic-card__title", card).text().trim() || $2("img", card).first().attr("alt")?.trim() || "";
      const image = $2("img", card).first().attr("src") ?? $2("img", card).first().attr("data-src") ?? "";
      if (!mangaId || !title || !image || seen.has(mangaId)) continue;
      const subtitle = [
        $2(".comic-card__meta", card).text().replace(/\s+/g, " ").trim(),
        $2(".comic-card__stat--rating", card).text().replace(/\s+/g, " ").trim()
      ].filter(Boolean).join(" \u2022 ");
      seen.add(mangaId);
  ...
  var MCR_IMAGE_CDN = "https://imgsrv4.com";
  var McReaderInfo = {
    version: "2.1.0",
    name: "McReader",
    icon: "icon.png",
  ...
  var McReader = class _McReader {
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      metadata = browse.currentPage < browse.totalPages ? { page: browse.currentPage + 1 } : void 0;
    ...
    async getSearchTags() {
      ...
      return [
        ...
        ...namespaceTagSections(parseTags($2), "genre", "exclude")
      ];
    }
    async getSearchResults(query, metadata) {
      ...
      const queryString = parameters.map(([key, value]) => `${encodeURIComponent(key)}=${encodeURIComponent(value)}`).join("&");
      const request = App.createRequest({
